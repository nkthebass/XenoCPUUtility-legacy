@echo off
REM XenoCPUUtility Legacy Build Script
REM Builds the legacy .NET Framework 4.0 version for Windows XP/Vista/7

setlocal enabledelayedexpansion

echo.
echo ======================================================================
echo  XenoCPUUtility Legacy Build Script
echo ======================================================================
echo.
...
echo.
"%MSBUILD_PATH%" "%PROJECT_FILE%" /p:Configuration=%CONFIG% /p:Platform=%PLATFORM% /p:DebugType=pdbonly
